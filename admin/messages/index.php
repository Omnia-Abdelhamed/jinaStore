                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <ul class="breadcome-menu" style="float: right;">
                                ...
                                <li><span class="bread-slash">/</span><a href="../messages/cancel/"> الغاء طلب </a></li>
                                <li><span class="bread-slash">/</span><span class="bread-blod"><a href="../messages/">الرسائل</a></span></li>
                            </ul>
                        </div>
                    </div>
                </div>
