...
<body class="materialdesign">
    <div class="wrapper-pro">
        <div class="left-sidebar-pro" class="print1">
            <nav id="sidebar">
        ...
        <div class="content-inner-all">
            <div class="header-top-area" id="print2">
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-1 col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="admin-logo logo-wrap-pro" class="print1">
            ...
            <!-- Breadcome End-->
            <!-- Mobile Menu start -->
            <div class="mobile-menu-area" class="print1" id="print1">
                <div class="container">
                    <div class="row">
